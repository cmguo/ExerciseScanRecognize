...
namespace TalBase.Widget
{
    ...
    /// </summary>
    public partial class TalMessageBox : TalWindow
    {
        #region Identity
        RoutedEventHandler _cancel;

        static TalMessageBox _instance;
        #endregion

        private TalMessageBox(string title, string content, bool isConfirm, bool showInTaskBar, AnimationStyles animateStyle)
        {
            InitializeComponent();
            Title = title;
        ...
        {
            var mbox = new TalMessageBox(title, content, false, showInTaskBar, animateStyle);
        ...
        {
            var mbox = new TalMessageBox(title, content, true, showInTaskBar, animateStyle);
            mbox.CheckButtonContent(buttons);
            if (!showInTaskBar)
                mbox.ShowInTaskbar = false;
            mbox.ShowDialog();
        ...
        {
            var mbox = new TalMessageBox("", "", false, false, AnimationStyles.Scale);
        ...
        {
            var mbox = new TalMessageBox(title, "", false, false, animateStyle);
            mbox.AllowForcingClose = false;
            _instance = mbox;
            mbox.CheckButtonContent(Buttons.Cancel);
            mbox._cancel = cancelCallback;
