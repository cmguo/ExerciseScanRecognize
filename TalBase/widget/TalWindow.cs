...
namespace TalBase.Widget
{
    public class TalWindow : Window
    {
        #region Import
        ...
        static TalWindow()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(TalWindow), new FrameworkPropertyMetadata(typeof(TalWindow)));
        }
        ...
        public override void OnApplyTemplate()
        {
            ...
            Loaded += delegate
            {
                if (AllowAutoCoverMask && (Owner as TalWindow) != null)
                {
                    (Owner as TalWindow).IsCoverMaskShow = true;
                }
                if (AnimateIn)
            ...
            _btnClose = VisualTreeHelper.GetChild(VisualTreeHelper.GetChild(grdNavbar, 1), 2) as TalButton;
        }
        ...
        protected override void OnClosing(CancelEventArgs e)
        {
            ...
            if (AllowAutoCoverMask && (Owner as TalWindow) != null)
            {
                ...
                else
                {
                    ...
                    {
                        var talwindow = window as TalWindow;
                        if (talwindow != null)
                        {
                            if (talwindow.AllowAutoCoverMask)
                            {
                                closeMask = true;
                                break;
                            }
        ...
        /// 使用动画打开窗体。
        /// </summary>
        internal static readonly RoutedEvent BeginLoadStoryboardEvent = EventManager.RegisterRoutedEvent("BeginLoadStoryboard", RoutingStrategy.Bubble, typeof(RoutedPropertyChangedEventHandler<TalWindow>), typeof(TalWindow));
        internal event RoutedPropertyChangedEventHandler<TalWindow> BeginLoadStoryboard
        {
        ...
        {
            RoutedPropertyChangedEventArgs<TalWindow> arg = new RoutedPropertyChangedEventArgs<TalWindow>(null, this, BeginLoadStoryboardEvent);
            RaiseEvent(arg);
        }
        ...
        /// 不使用动画打开窗体。
        /// </summary>
        internal static readonly RoutedEvent SkipLoadStoryboardEvent = EventManager.RegisterRoutedEvent("SkipLoadStoryboard", RoutingStrategy.Bubble, typeof(RoutedPropertyChangedEventHandler<TalWindow>), typeof(TalWindow));
        internal event RoutedPropertyChangedEventHandler<TalWindow> SkipLoadStoryboard
        {
        ...
        {
            RoutedPropertyChangedEventArgs<TalWindow> arg = new RoutedPropertyChangedEventArgs<TalWindow>(null, this, SkipLoadStoryboardEvent);
            RaiseEvent(arg);
        }
        ...
        /// 使用动画关闭窗体。
        /// </summary>
        internal static readonly RoutedEvent BeginCloseStoryboardEvent = EventManager.RegisterRoutedEvent("BeginCloseStoryboard", RoutingStrategy.Bubble, typeof(RoutedPropertyChangedEventHandler<TalWindow>), typeof(TalWindow));
        internal event RoutedPropertyChangedEventHandler<TalWindow> BeginCloseStoryboard
        {
        ...
        {
            RoutedPropertyChangedEventArgs<TalWindow> arg = new RoutedPropertyChangedEventArgs<TalWindow>(null, this, BeginCloseStoryboardEvent);
            RaiseEvent(arg);
        }
        ...
        public static readonly DependencyProperty ResultProperty =
            DependencyProperty.Register("Result", typeof(object), typeof(TalWindow));
        ...
        public static readonly DependencyProperty IsCoverMaskShowProperty =
            DependencyProperty.Register("IsCoverMaskShow", typeof(bool), typeof(TalWindow));
        ...
        public static readonly DependencyProperty AllowShowDelayProperty =
            DependencyProperty.Register("AllowShowDelay", typeof(bool), typeof(TalWindow));
        ...
        public static readonly DependencyProperty NavButtonVisibilityProperty =
            DependencyProperty.Register("NavButtonVisibility", typeof(Visibility), typeof(TalWindow), new PropertyMetadata(Visibility.Visible));
        ...
        public static readonly DependencyProperty AnimateInProperty =
            DependencyProperty.Register("AnimateIn", typeof(bool), typeof(TalWindow), new PropertyMetadata(true));
        ...
        public static readonly DependencyProperty AnimateOutProperty =
            DependencyProperty.Register("AnimateOut", typeof(bool), typeof(TalWindow), new PropertyMetadata(true));
        ...
        public static readonly DependencyProperty AnimationStyleProperty =
            DependencyProperty.Register("AnimationStyle", typeof(AnimationStyles), typeof(TalWindow), new PropertyMetadata(AnimationStyles.Scale));
        ...
        public static readonly DependencyProperty BorderCornerRadiusProperty =
            DependencyProperty.Register("BorderCornerRadius", typeof(CornerRadius), typeof(TalWindow));
        ...
        public static readonly DependencyProperty HeaderProperty =
            DependencyProperty.Register("Header", typeof(object), typeof(TalWindow));
        ...
        public new static readonly DependencyProperty IconProperty =
            DependencyProperty.Register("Icon", typeof(object), typeof(TalWindow));
        ...
        public static readonly DependencyProperty NavbarBackgroundProperty =
            DependencyProperty.Register("NavbarBackground", typeof(Brush), typeof(TalWindow));
        ...
        public static readonly DependencyProperty NavbarHeightProperty =
            DependencyProperty.Register("NavbarHeight", typeof(double), typeof(TalWindow));
        ...
        public static readonly DependencyProperty NavButtonHeightProperty =
            DependencyProperty.Register("NavButtonHeight", typeof(double), typeof(TalWindow));
        ...
        public static readonly DependencyProperty NavButtonWidthProperty =
            DependencyProperty.Register("NavButtonWidth", typeof(double), typeof(TalWindow));
        ...
        public static readonly DependencyProperty IsAwaitShowProperty =
            DependencyProperty.Register("IsAwaitShow", typeof(bool), typeof(TalWindow));

        /// <summary>
        /// 获取或设置是否允许在调用Show或ShowDialog方法时自动打开父窗体的遮罩层，并在Close时将其关闭。
        /// <para>若没有父窗体或父窗体不是TalWindow类型，则不会触发任何效果。</para>
        /// </summary>
        ...
        public static readonly DependencyProperty AllowAutoCoverMaskProperty =
            DependencyProperty.Register("AllowAutoCoverMask", typeof(bool), typeof(TalWindow), new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty AllowForcingCloseProperty =
            DependencyProperty.Register("AllowForcingClose", typeof(bool), typeof(TalWindow), new PropertyMetadata(true));
        ...
        public static readonly DependencyProperty AllowAutoOwnerProperty =
            DependencyProperty.Register("AllowAutoOwner", typeof(bool), typeof(TalWindow), new PropertyMetadata(false, OnAllowAutoOwnerChanged));

        private static void OnAllowAutoOwnerChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            var window = d as TalWindow;
        ...
        private static TalWindow GetWindowFromHwnd(IntPtr hwnd)
        {
            var visual = HwndSource.FromHwnd(hwnd).RootVisual;
            return visual as TalWindow;
        }
        private static TalWindow GetOwnerWindow()
        {
    ...
    internal class CloseWindowCommand : ICommand
    {
        ...
        {
            var window = (parameter as TalWindow);
            window.Close();
        }
    }
    ...
    internal class MinWindowCommand : ICommand
    {
        ...
        public void Execute(object parameter)
        {
            (parameter as TalWindow).WindowState = WindowState.Minimized;
        }
    }
